...
public class FenetreJeu extends Frame {
    ...
    public FenetreJeu(String pseudo){    
        ...
        // Bouton Continuer pour visualiser le score apr�s le jeu
    	...
    	bContinuer.setVisible(false); // Non visible au d�part
        add(bContinuer);
        
        // TextArea Explication des r�gles
        ...
        partie.ajouterRegle(1, differentesValeursMemesCouleurs, somme); // D�pareill� en valeur mais m�me couleur : Ajout de la somme des valeurs
        partie.ajouterRegle(1, differentesValeursDifferentesCouleurs, somme); // D�pareill� en valeur et en couleur : Ajout de la somme des valeurs
        partie.ajouterRegle(2, memesValeursDifferentesCouleurs, retireSomme); // M�me valeur mais d�pareill� en couleur : Soustrait de la somme des valeurs
        partie.ajouterRegle(3, memesValeursMemesCouleurs, retireDoubleSomme); // M�me valeur et m�me couleur : Soustrait le double de la somme des valeurs
    ...
    public void joueUnTour(){
        ...
        //Met � jour les composants sur la fen�tre
        this.revalidate();
        this.repaint();
    }
